...
video_capture = cv2.VideoCapture("22.mp4")
...
while a == 513:
    ...
    face_recognition("carometro_legislatura56/image-%003d.jpg" % a)
    face_encoding(face_recognition)[0]
    print(know_face_encodings)
